...
class LLMJudge:
    ...
    JUDGE_PROMPT = """你是一个安全生产 AI 助手的质量评估专家。请对以下助手响应进行评分。
...
DEFAULT_INTENT_CASES: List[IntentTestCase] = [
    IntentTestCase("反应器温度报警了怎么处理？",           "equipment_alarm"),
    IntentTestCase("泵检修前要做哪些安全准备？",           "equipment_maintenance"),
    IntentTestCase("动火作业票怎么办、谁来审批？",         "work_permit"),
    IntentTestCase("受限空间作业前要做哪些气体检测？",     "work_permit"),
    IntentTestCase("安全生产法对隐患排查治理有什么要求？", "regulation_query"),
    IntentTestCase("甲醇泄漏了，现在应该怎么应急处置？",   "emergency_response"),
    IntentTestCase("车间有人受伤了，事故上报流程是什么？", "incident_report"),
    IntentTestCase("危化品库房储存有什么要求？",           "chemical_safety"),
    IntentTestCase("进装置区需要穿什么防护用品？",         "ppe_inquiry"),
    IntentTestCase("电工证到期了怎么复审？",               "training_cert"),
    IntentTestCase("罐区巡检要注意什么风险点？",           "hazard_inspection"),
    IntentTestCase("你好",                                 "greeting"),
    IntentTestCase("转人工，我要找安全专家",               "escalation"),
]

DEFAULT_DIALOG_CASES: List[Dict[str, Any]] = [
    {"question": "装置区巡检发现管道法兰处渗漏，该怎么处置？"},
    {"question": "明天要动火，作业票办理流程和监护人要求是什么？"},
    {"question": "新员工三级安全教育包括哪些内容？"},
    {"turns": ["你好", "我们车间下周有受限空间作业，需要准备什么？", "气体检测的合格标准是多少？"]},
]
